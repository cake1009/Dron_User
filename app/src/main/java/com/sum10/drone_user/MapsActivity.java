    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert_confirm.setMessage("현재 위치가 맞는지 다시 확인해주세요. 호출할까요?").setCancelable(false).setPositiveButton("호출",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // 'YES'
                                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(MapsActivity.this);
                                alertBuilder.setTitle("맡길 물품보관소 위치를 선택하세요.");

                                final ArrayAdapter<String> adapter = new ArrayAdapter<String>(MapsActivity.this, android.R.layout.select_dialog_singlechoice);
                                adapter.add("광주역");
                                adapter.add("광주송정역");
                                adapter.add("유스퀘어");
                                ...
                                alertBuilder.setAdapter(adapter,
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int whichButton) {
                                                String locker = adapter.getItem(whichButton);
                                                Intent intent = new Intent(MapsActivity.this, WaitingActivity.class);
                                                LatLng myloc = new LatLng(lat, lng);
                                                String address = getCurrentAddress(myloc);
                                                intent.putExtra("lat", lat);
                                                intent.putExtra("lng", lng);
                                                intent.putExtra("myloc", address);
                                                intent.putExtra("locker", locker);
                                                CallInfo callinfo = new CallInfo(address, locker, false);
                                                myRef.child("callservice").push().setValue(callinfo);
